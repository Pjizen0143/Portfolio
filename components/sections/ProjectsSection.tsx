...
const PROJECTS_DATA: Project[] = [
  {
    ...
    status: "STATUS: INPROGRESS // OPEN_SOURCE",
    image: "/PFi.png",
  },
  {
      ...
      <div className="mx-auto max-w-280 px-5 sm:px-8">
        ...
        <header className="border-b border-surface-container-low pb-6 mb-10">
          ...
          <p className="typ-body-lg text-on-surface-variant mt-2 max-w-2xl">
            An interactive console presentation showcasing core tools, modular
            systems, and digital surfaces built with structural intent.
          </p>
        </header>
        ...
        <div className="w-full border-2 border-surface-container-highest rounded-lg bg-surface-container-lowest overflow-hidden shadow-md flex flex-col">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 min-h-125">
            ...
            <div className="lg:col-span-5 border-r-0 lg:border-r border-surface-container-highest flex flex-col justify-between">
                ...
                {PROJECTS_DATA.map((proj, idx) => {
                  ...
                  return (
                    <button
                      ...
                      className={`flex-1 min-w-30 py-3.5 px-4 font-mono text-[11px] uppercase tracking-wider text-center border-r border-b lg:border-b-0 border-surface-container-highest/60 transition-all select-none cursor-pointer ${
                        isActive
              ...
              <div
                className="p-6 sm:p-8 flex-1 flex flex-col justify-between animate-fade-in"
                key={activeIdx}
              >
                <div>
                  ...
                  <div className="flex flex-wrap items-center justify-between gap-2 mb-4">
                    ...
                    <span className="typ-label-mono text-[10px] text-on-surface-variant/70 flex items-center gap-1.5">
                      <span
                        className={`w-1.5 h-1.5 rounded-full inline-block ${activeProject.confidential ? "bg-error animate-pulse" : "bg-primary animate-pulse"}`}
                      ></span>
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-1.5 mb-8">
                    {activeProject.tags.map((tag) => (
                      <span
                        key={tag}
                        className="chip-mono text-[9px] font-mono tracking-wider py-0.5 px-2.5 bg-surface-container-low border border-surface-container-highest text-on-surface-variant"
                      >
                        {tag}
                      </span>
                    ))}
                  ...
                  {activeProject.confidential ? (
                    ...
                    >
                      ...
                      >
                        <path
                          fillRule="evenodd"
                          d="M14.47 2.47a.75.75 0 0 1 1.06 0l6 6a.75.75 0 0 1 0 1.06l-6 6a.75.75 0 1 1-1.06-1.06l4.72-4.72H9a5.25 5.25 0 0 0-5.25 5.25v3a.75.75 0 0 1-1.5 0v-3A6.75 6.75 0 0 1 9 5.25h10.19l-4.72-4.72a.75.75 0 0 1 0-1.06Z"
                          clipRule="evenodd"
                        />
                      </svg>
                      ACCESS_SOURCE_CODE
            ...
            <div className="lg:col-span-7 bg-surface-container-lowest/40 p-4 sm:p-6 flex items-center justify-center">
              <div
                className="w-full max-w-2xl border-2 border-surface-container-highest rounded-md overflow-hidden bg-surface-container-lowest shadow-level-1 flex flex-col animate-fade-in"
                key={activeIdx}
              >
                ...
                <div className="border-b border-surface-container-highest px-3 py-2 flex items-center bg-surface-container-low select-none">
                  ...
                  <div className="mx-auto w-3/5 bg-surface-container-lowest rounded border border-surface-container-highest/60 text-center py-0.5 text-[8px] font-mono text-on-surface-variant/60 tracking-wider truncate">
                    HTTP://LOCALHOST:3000/PORTFOLIO/PREVIEW/
                    {activeProject.title
                      .toLowerCase()
                      .replace(/[^a-z0-9]/g, "-")}
                    .sys
                ...
                <div className="relative w-full h-70 sm:h-87.5 overflow-hidden bg-surface-container-lowest flex items-center justify-center select-none group">
                  {activeProject.image ? (
                    <div className="relative w-full h-full">
                      ...
                      <div className="absolute inset-0 bg-linear-to-t from-black/50 via-transparent to-transparent pointer-events-none opacity-60 group-hover:opacity-40 transition-all duration-500"></div>
                    ...
                    <div className="absolute inset-0 bg-black/95 flex flex-col items-center justify-center p-6 text-center border border-error/20">
                      ...
                      <div className="absolute inset-x-0 top-0 h-0.5 bg-error/30 animate-pulse pointer-events-none"></div>
                      ...
                      <div className="typ-label-mono text-[9px] text-on-surface-variant/80 max-w-sm leading-normal font-mono mb-6 uppercase">
                        RESTRICTED DIRECTORY LOG // EXCLUSIVITY CLEARANCE 00-L3
                        REQUESTED BY DEV_ADMIN
                      </div>
